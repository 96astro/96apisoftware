import { LifeCalculatorSchemaType } from "@/lib/zod";

export type LifeCalculatorApiPayload = {
  name: string;
  gender: string;
  day: number;
  month: number;
...
export function parseBirthParts(birthDate: string, birthTime: string): ParsedBirthParts {
...
export function toApiGender(gender: LifeCalculatorSchemaType["gender"]): string {
